...
## MBTI존 41~60 novel mechanic 5종 적용 (2026-07-18)
41~60번은 전부 텍스트만 있는 스켈레톤(이미지·테마 미정) 상태였는데, 사용자가 최근 몰입테스트
(#25/#30/#33/#39)처럼 20개 중 5개(4개당 1개 비율)는 표준 "8문항×4지선다" mbti4 틀을 벗어난
...
5개 전부 JSON 파싱 검증 + engine.js가 실제로 읽는 필드명과 일치하는지 대조 완료. **이미지·테마
